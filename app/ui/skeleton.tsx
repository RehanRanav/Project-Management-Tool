export const TaskColumnSkeleton = () => {
  return (
    <div className="bg-gray-200 w-full animate-pulse">
...
export const ProjectInfoPanelSkeleton = () => {
  return (
    <>
      <div className="flex gap-2 p-4 mt-4 justify-start items-center bg-gray-100 animate-pulse">
        <svg
      ...
      <div className="p-2 flex flex-col gap-4 m-0.5 rounded text-sm animate-pulse">
...
export const MultipleProjectCards = () => {
  return (
    <>
      <ProjectCardsSkeletons />
      <ProjectCardsSkeletons />
      <ProjectCardsSkeletons />
      <ProjectCardsSkeletons />
    </>
...
export const ProjectCardsSkeletons = () => {
  return (
    <div className="px-3 py-2 shadow-sm shadow-gray-300 bg-white hover:shadow-md border rounded-sm flex flex-col justify-between cursor-pointer w-52 h-40 max-w-52 max-h-48 animate-pulse">
      ...
      <div className=" rounded-sm p-0.5 h-10 bg-gray-100"></div>
      <div className="flex justify-between items-end">
        <div className="w-full flex gap-1 items-center">
          <span className="w-2 rounded h-3 bg-gray-200"></span>
          <span className="w-1/2 rounded h-3 bg-gray-200"></span>
        </div>
        <svg
          className="w-10 h-10 me-3 text-gray-200 dark:text-gray-700"
          aria-hidden="true"
